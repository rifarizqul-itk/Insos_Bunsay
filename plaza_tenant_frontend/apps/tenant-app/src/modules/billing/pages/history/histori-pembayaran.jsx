...
import { Table, Card, Badge, AlokasiBreakdown, EmptyState, SkeletonTable } from '@bunsay/shared-ui';
import { MockTransactionAdapter } from '@bunsay/shared-core';
...
function HistoriPembayaran() {
  ...
  useEffect(() => {
    MockTransactionAdapter.query({ scope: 'HISTORY', tenantId: 1 })
