...
import { Icon, Table, Card, Button, AlokasiBreakdown, EmptyState } from '@bunsay/shared-ui';

function VerifikasiBuktiTransfer({ selectedTenant = null }) {
  const [previewItem, setPreviewItem] = useState(null);

  const transferAntrean = [
    {
      id: 'TRX-1092',
      nama: 'Eva Tauresea',
      kios: 'B-1004',
      ...
      labelMetode: 'Transfer Bank Manual',
  ...
  const handleAksi = (id, statusKonfirmasi) => {
    alert(`Transaksi ${id} di-${statusKonfirmasi === 'konfirmasi' ? 'setujui' : 'tolak'}`);
    setPreviewItem(null);
  };
