...
export class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div data-slot="error-boundary" className="p-6 bg-white rounded-xl border border-red/20 shadow-card text-center flex flex-col items-center justify-center gap-4 my-8 font-sans">
