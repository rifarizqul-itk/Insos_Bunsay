...
/**
 * Shared Presentational Component: AlokasiBreakdown
 * Menampilkan rincian alokasi rupiah yang terserap pada tiap tagihan
 * dari satu transaksi pembayaran yang sudah tercatat/diverifikasi.
 * 
 * @param {Object} props
 * @param {Array} props.alokasiList - Array alokasi [{ idTagihan, periode, nominalTeralokasi, statusAkhir }]
 * @param {boolean} [props.compact=false] - Tampilan ringkas untuk tabel data
 */
