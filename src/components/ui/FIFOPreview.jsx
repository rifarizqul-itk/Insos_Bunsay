...
/**
 * Shared Presentational Component: FIFOPreview
 * Menampilkan rincian alokasi FIFO secara real-time berdasarkan nominal yang diinput.
 * 
 * @param {Object} props
 * @param {Array} props.allocations - Array alokasi FIFO dari utility allocatePaymentFIFO
 * @param {number} props.nominal - Total nominal pembayaran yang diisi user
 */
